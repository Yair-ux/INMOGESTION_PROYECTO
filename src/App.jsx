...
export default function App() {
  ...
  <span className="text-white text-2xl font-bold tracking-wide">InmoGestión</span>
</div>
  ...
  onClick={() => setMenuAbierto(!menuAbierto)} // alterna abierto/cerrado
>
  {menuAbierto ? (
    // Ícono de cerrar
  ...
  <nav className="md:hidden bg-blue-800 text-white flex flex-col px-6 py-4 space-y-4">
    ...
    <a href="#" className="hover:text-yellow-400">Propiedades</a>
    <a href="#" className="hover:text-yellow-400">Agentes</a>
